export const s = {
	basketSummary: /*tw*/ 'bg-branded h-min text-white py-[30px] px-4 w-[335px] text-[17px] space-y-4',
	order: /*tw*/ 'text-[18px] font-bold',
	summaryItem: /*tw*/ 'flex justify-between items-center',
