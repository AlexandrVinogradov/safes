	...
	return (
		<MainModal isOpen={isCutModal} onClose={handleClose}>
			<div className={s.wrapper}>
				...
				<p className={s.item}>
					4. Подтверждением более низкой цены товара является страница на официальном сайте Конкурента. Сайт Конкурента должен
					быть актуальным и содержать обновленную информацию на день обращения.
				</p>
				<p className={s.item}>
				...
				<p className={s.item}>
					7. Менеджер компании вправе отказать в предоставлении скидки по программе, если не предоставляется возможности убедиться
					в актуальности цены Конкурента или подтвердить наличие товара.
				</p>
				...
				<div className={s.buttonWrapper}>
					<Button className={s.button}>% Отправить заявку на скидку</Button>
				</div>
			</div>
		</MainModal>
	)
