export const s = {
	popup: /*tw*/ 'absolute z-10 flex flex-col items-center pt-[22px] pb-[31px] px-5 top-[47px] right-0 bg-white text-dark w-[358px] rounded-[3px] border border-[#C7EAFF] shadow-[0px_4px_4px_rgba(0,0,0,0.25)]',
