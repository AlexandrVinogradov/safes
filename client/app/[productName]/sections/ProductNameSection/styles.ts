export const s = {
	section: /*tw*/ 'pt-[80px] pb-[77px]',
	wrapper: /*tw*/ 'flex',
	image: /*tw*/ 'w-auto h-full w-[690px]',

	code: /*tw*/ 'text-xl text-dimText pb-[30px] font-normal',
	name: /*tw*/ 'text-[46px] pb-[30px]',
	prices: /*tw*/ 'flex items-center pb-2.5',
	...
	orderButtons: /*tw*/ 'flex items-center justify-between max-w-[690px] w-full',
	oderButton: /*tw*/ 'w-[315px]',
}
